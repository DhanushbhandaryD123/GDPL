    ...
    <section className="py-20 md:py-32 bg-white overflow-hidden relative">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 max-w-7xl">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          {/* Left Side: Mockups */}
          <div className="w-full lg:w-1/2 relative min-h-[450px] md:h-[600px] flex justify-center items-center mb-10 lg:mb-0">
            ...
            <motion.div 
              ...
              className="absolute z-10 w-[60%] sm:w-[80%] h-1 md:h-2 bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 blur-sm top-1/2 -translate-y-1/2 rounded-full"
            />
            <motion.div 
              ...
              className="absolute z-10 w-[60%] sm:w-[80%] h-[2px] bg-gradient-to-r from-blue-300 via-indigo-300 to-purple-300 border-t border-dashed border-white/50 top-1/2 -translate-y-1/2"
            />
            ...
            <motion.div 
              ...
              className="absolute left-0 sm:left-[5%] md:left-[10%] z-20 w-[160px] sm:w-[220px] md:w-[300px] aspect-[3/4] bg-[#f8f9fa] rounded-[1.5rem] md:rounded-[2.5rem] border-4 md:border-8 border-white shadow-[0_30px_60px_rgba(0,0,0,0.12)] overflow-hidden hover:rotate-0 hover:scale-105 transition-all duration-500"
            >
              <div className="absolute inset-0 bg-[#0f172a] flex flex-col items-center justify-center p-4">
                <motion.div 
                  animate={{ scale: [1, 1.1, 1] }}
                  transition={{ duration: 2, repeat: Infinity }}
                  className="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-4 border-white/20 mb-6 flex items-center justify-center relative"
                >
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-white rounded-full flex items-center justify-center">
                    <div className="w-10 h-10 sm:w-14 sm:h-14 bg-red-500 rounded-full opacity-0" />
                  </div>
                  {/* Radar pulse effect */}
                  <div className="absolute inset-0 rounded-full border border-white/40 animate-ping" />
                </motion.div>
                <p className="text-white text-[10px] sm:text-xs font-bold tracking-[0.2em] uppercase text-center">Remote Viewfinder</p>
                <div className="mt-8 sm:mt-12 flex gap-6 text-white/40">
                  <Wifi size={24} className="sm:w-8 sm:h-8" />
                  <Bluetooth size={24} className="sm:w-8 sm:h-8" />
                </div>
              </div>
            </motion.div>
            ...
            <motion.div 
              ...
              className="absolute right-0 sm:right-[5%] md:right-[5%] z-30 w-[130px] sm:w-[170px] md:w-[240px] aspect-[9/19.5] bg-gray-900 rounded-[2rem] md:rounded-[3rem] border-[4px] md:border-[8px] border-gray-800 shadow-[0_30px_60px_rgba(0,0,0,0.3)] overflow-hidden hover:rotate-0 hover:scale-105 transition-all duration-500"
            >
              <div className="absolute top-0 inset-x-0 h-6 md:h-8 bg-black z-10 flex justify-center rounded-b-2xl md:rounded-b-3xl max-w-[50%] mx-auto" />
              <img 
              ...
              />
              {/* Camera UI Overlay */}
              <div className="absolute inset-0 border-[1px] border-white/20 m-2 rounded-[1.5rem] md:rounded-[2rem] pointer-events-none" />
              <div className="absolute bottom-6 left-1/2 -translate-x-1/2 w-10 h-10 md:w-14 md:h-14 rounded-full border-2 border-white/50 flex items-center justify-center backdrop-blur-sm pointer-events-none">
                <div className="w-8 h-8 md:w-12 md:h-12 bg-white/90 rounded-full" />
              </div>
            </motion.div>
          </div>
