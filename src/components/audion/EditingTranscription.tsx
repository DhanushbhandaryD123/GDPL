...
export function EditingTranscription() {
  return (
    <section className="py-24 bg-[#0a0526] relative border-t border-white/5">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            Powerful <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-teal-400">Post-Recording Workflow</span>
          </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {workflowSteps.map((step, index) => (
            <motion.div
              ...
              className="bg-[#030014]/80 backdrop-blur-sm p-8 rounded-3xl border border-white/10 hover:-translate-y-2 transition-transform duration-300"
            >
              <div className="mb-8">
