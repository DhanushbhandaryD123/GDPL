...
export function FloatingSocials() {
  ...
  return (
    ...
    >
      <a href="#" aria-label="Facebook" className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center hover:bg-white/40 transition">
        <Facebook className="w-4 h-4 text-white fill-current" />
      </a>
      <a href="#" aria-label="X (Twitter)" className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center hover:bg-white/40 transition">
      ...
      <a href="#" aria-label="LinkedIn" className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center hover:bg-white/40 transition">
        <Linkedin className="w-4 h-4 text-white fill-current" />
      </a>
      <a href="#" aria-label="YouTube" className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center hover:bg-white/40 transition">
