...
import { r as requireReact, a as requireUtils, b as requirePatterns, g as getDefaultExportFromCjs } from "./index-C9fJfQdw.js";
  ...
  class FilePlayer2 extends import_react.Component {
    constructor() {
      ...
      __publicField(this, "renderSourceElement", (source, index) => {
        ...
        return /* @__PURE__ */ import_react.default.createElement("source", __spreadValues({ key: index }, source));
      });
      __publicField(this, "renderTrack", (track, index) => {
        return /* @__PURE__ */ import_react.default.createElement("track", __spreadValues({ key: index }, track));
      });
